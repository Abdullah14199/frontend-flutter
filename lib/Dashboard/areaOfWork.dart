...
import 'package:skep_home_pro/constatns/delivery_area.dart';
...
class _AreaOfWorkState extends State<AreaOfWork> {
  ...
  Future<List<AllCitys>> fetchPosts() async {
    ...
    return (responseJson['AllCitys'] as List).map((p) => AllCitys.fromJson(p)).toList();
  }
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                    ...
                    right: 2,
                    child: Padding(
                      padding: const EdgeInsets.only(left: 30 , right: 360 , top: 10),
                      child: RoundCheckBox(
                        onTap: (value) {
                          Etobicoke = value;
                        },
