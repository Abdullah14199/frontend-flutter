...
class _AreaOfWorkState extends State<AreaOfWork> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: Stack(
        children: [
          GetBuilder<GoogleMapViewModel>(
            init: GoogleMapViewModel(),
  ...
  void _modalBottomSheetMenu(context, GoogleMapViewModel controller,) {
              ...
              children: [
                ...
                Positioned(
                    ...
                    child: Padding(
                      ...
                      child: RoundCheckBox(
                        onTap: (value) {
                          controller.Etobicoke = value!;
                          controller.myPolygon();

                        },
                        size: 40,

                        isChecked: controller.Etobicoke,
                ...
                Positioned(
                    ...
                    child: Padding(
                      ...
                      child: RoundCheckBox(
                        onTap: (value) {
                          controller.Mississauga = value!;
                          controller.myPolygon();
                        },
                        size: 40,
                        isChecked: controller.Mississauga,
                        checkedColor: constants.blue2,
                        uncheckedColor: Colors.white,
                      ),
                    )),
                Positioned(
                    ...
                    child: Padding(
                      ...
                      child: RoundCheckBox(
                        onTap: (value) {
                          controller.Toronto = value!;
                          controller.myPolygon();
                        },
                        size: 40,
                        isChecked: controller.Toronto,
                        checkedColor: constants.blue2,
                        uncheckedColor: Colors.white,
                      ),
                    )),
