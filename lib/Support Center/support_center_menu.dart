...
class SupportCenterMenu extends StatefulWidget {

  SupportCenterMenu({Key? key}) : super(key: key);

  @override
  State<SupportCenterMenu> createState() => _SupportCenterMenuState();
}

class _SupportCenterMenuState extends State<SupportCenterMenu> {
                    ...
                    child: Directionality(
                      ...
                      child: ElevatedButton.icon(
                          ...
                          onPressed: isButtonActive ? () {
                            ...
                            controller.getSupportCenterMenu(_controllerTitle.text, _controllerDescription.text , context);
                          } : null
                      ),
                    ),
                  ),
